 ...
 ******************************************************************************/
#ifndef FACE_LMCLS_MODEL_HPP
#define FACE_LMCLS_MODEL_HPP
...
class FaceLandmarkClsModel : public Model
{

public:
    /* Indices for the expected model - based on input tensor shape */
    static constexpr uint32_t ms_inputLandmarkNumsIdx     = 1;
