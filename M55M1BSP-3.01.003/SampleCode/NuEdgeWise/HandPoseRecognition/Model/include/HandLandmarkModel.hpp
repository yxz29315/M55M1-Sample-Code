/**************************************************************************//**
 * @file     HandLandmarkModel.hpp
 * @version  V1.00
 * @brief    Hand landmark model header file
 *
 * @copyright SPDX-License-Identifier: Apache-2.0
 * @copyright Copyright (C) 2024 Nuvoton Technology Corp. All rights reserved.
 ******************************************************************************/
#ifndef HAND_LANDMARK_MODEL_HPP
#define HAND_LANDMARK_MODEL_HPP
...
class HandLandmarkModel : public Model
{
