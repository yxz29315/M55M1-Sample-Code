...
/**
 * @brief   Post-processing class for Face Detection use case.
...
private:
    ...
    std::vector<face_detection::DetectionResult> &m_results;       /* Single inference results. */
    const face_detection::PostProcessParams &m_postProcessParams;  /* Post processing param struct. */
    face_detection::Network m_net;                                 /* YOLO network object. */
    /**
