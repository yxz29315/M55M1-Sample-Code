...
// Public functions
//----------------------------------------------------------------------------
BOOL LabelFileReader_Initialize(
...
BOOL LabelFileReader_Finish(VOID)
{
...
INT32 LabelFileReader_ReadData(
    BYTE               *pbyData,
    INT32              i32DataSize
)
{
...
INT32 LabelFileReader_FileSize(VOID)
{
    return f_size(&labelFileObject);
}

VOID LabelFileReader_Rewind(VOID)
{
