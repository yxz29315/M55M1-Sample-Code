...
bool ImgClassPostProcess::DoPostProcess_ASmodel(bool useSoftmax)
{
    return this->m_imgClassifier.GetClassificationResults(
               this->m_model->GetOutputTensor(0), this->m_results,
               this->m_labels, 2, useSoftmax);
}

ClassificationResult ImgClassPostProcess::getResults()
{
    return this->m_results[0];
}

std::vector<ClassificationResult> ImgClassPostProcess::getTopkResults()
{
